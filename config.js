const nameGirl = '20-10 vui vẻ bạn nhó!!';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc bạn của tôi 20/10 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với bạn Chang trong hôm nay và cả những ngày sau';
